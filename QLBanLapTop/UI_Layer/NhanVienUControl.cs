...
{
    public partial class NhanVienUControl : UserControl
    {
        ...
        {
            if (manv != "" && txtHoTen.Text.Trim() != ""
                && txtDiaChi.Text.Trim() != "" && txtCaLam.Text.Trim() != ""
                && txtKinhNghiem.Text.Trim() != "" && txtLuong.Text.Trim() != ""
                )

            {
                DialogResult check = MessageBox.Show("Bạn có muốn Sửa Nhân Viên" + " " + manv, "Thông báo",
        ...
        private void dgvNhanVien_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (r >= 0)
            {
                ...
                manv = dgvNhanVien.Rows[r].Cells[0].Value.ToString().TrimEnd();
        ...
        private void NhanVienUControl_Load(object sender, EventArgs e)
        {
            LoadData();
        }
